...
export default function DetailPageClient() {
    ...
    return (
        <div className="max-w-5xl mx-auto px-6 py-10">
            <button
                onClick={() => router.back()}
                className="flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-lg mb-4"
            >
                ← <span>뒤로가기</span>
            </button>
            ...
            <div className="bg-white rounded-xl shadow p-8 flex gap-8 mb-10">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-gray-700 mb-4">생성일: {new Date(book.bookCreateDt).toLocaleDateString('ko-KR', {
                        year: 'numeric',
                        month: 'long',
                        day: 'numeric'
                    })}</p>
